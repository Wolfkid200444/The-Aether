...
//    }
    ...
    public static Pair<ResourceLocation, ListModel<Boat>> getModelWithLocation(EntityRendererProvider.Context context, boolean chest) {
        return Pair.of(chest ? SKYROOT_CHEST_BOAT : SKYROOT_BOAT, chest ? new ChestBoatModel(context.bakeLayer(AetherModelLayers.SKYROOT_CHEST_BOAT)) : new BoatModel(context.bakeLayer(AetherModelLayers.SKYROOT_BOAT)));
    }
}
