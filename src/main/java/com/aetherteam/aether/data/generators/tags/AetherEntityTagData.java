...
//
//        // Forge
//        this.tag(ConventionalEntityTypeTags.BOSSES).add(
//                AetherEntityTypes.SLIDER.get(),
//                AetherEntityTypes.VALKYRIE_QUEEN.get(),
//                AetherEntityTypes.SUN_SPIRIT.get()
//        );
//        this.tag(ConventionalEntityTypeTags.CAPTURING_NOT_SUPPORTED).add(
//            AetherEntityTypes.SLIDER.get(),
//            AetherEntityTypes.VALKYRIE_QUEEN.get(),
//            AetherEntityTypes.SUN_SPIRIT.get()
//        );
//        this.tag(ConventionalEntityTypeTags.TELEPORTING_NOT_SUPPORTED).add(
//            AetherEntityTypes.SLIDER.get(),
//            AetherEntityTypes.VALKYRIE_QUEEN.get(),
//            AetherEntityTypes.SUN_SPIRIT.get()
//        );
