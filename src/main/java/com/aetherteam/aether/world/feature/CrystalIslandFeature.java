...
public class CrystalIslandFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        PlacedFeature feature = PlacementUtils.inlinePlaced(context.level().registryAccess().holderOrThrow(AetherConfiguredFeatures.CRYSTAL_TREE_CONFIGURATION)).value();
