...
public interface ItemStackExtension {
    default int aetherFabric$getEnchantmentLevel(Holder<Enchantment> enchantment) {
        return throwUnimplementedException();
    }

    default Set<Object2IntMap.Entry<Holder<Enchantment>>> aetherFabric$getAllEnchantments(HolderLookup.RegistryLookup<Enchantment> registry) {
        return throwUnimplementedException();
    }
